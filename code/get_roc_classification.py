...
for i in range(0,L):
    mat_data = sio.loadmat('/Users/mahima/Downloads/PIDFOREST-MASTER/data/'+datasets[i]+'.mat')
    X = mat_data['X']
    ...
    for j in range(0,trials):
        ...
        auc_all[j, 1] = metrics.roc_auc_score(y, -y_score_DTM)
        ap_all[j, 1] = average_precision_score(y, -y_score_DTM)
        ...
        ap_all[j, 2] = average_precision_score(y, alg_scores)
        ...
        if False:
            ...
            ap_all[j, 4] = average_precision_score(y, alg_scores)
            print('\n******SVM*******\n')
            ...
            ap_all[j, 5] = average_precision_score(y, alg_scores)
    ...
    #file_name= os.path.join('/Users/mahima/Downloads/PIDFOREST-MASTER/experiment_results/',datasets[i] + '.pdf')

    #if not os.path.exists('/Users/mahima/Downloads/PIDFOREST-MASTER/experiment_results/'+datasets[i] + '.pdf'):
        #with open('/Users/mahima/Downloads/PIDFOREST-MASTER/experiment_results/'+datasets[i] + '.pdf', 'w'): pass
